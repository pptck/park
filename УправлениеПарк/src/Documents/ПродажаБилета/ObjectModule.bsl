...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Движение.КоличествоПосещений = СвойстваНоменклатуры.КоличествоПоосещений;
...
Функция СвойстваНоменклатуры(Номенклатура)
	...
	|	Номенклатура.КоличествоПоосещений
	|ИЗ
	...
	Результат.Вставить("КоличествоПоосещений", Выборка.КоличествоПоосещений);
