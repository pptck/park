...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	ДвижениеПА = Движения.ПосещенияАттракционов.Добавить();
	ДвижениеПА.Период = Дата;
	ДвижениеПА.Аттракцион = Атракцион;
	ДвижениеПА.Количество = 1; 
	ДвижениеПА.Клиент = КлиентПоОснованию();
